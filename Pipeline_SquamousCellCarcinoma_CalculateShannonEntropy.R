...
df_stage_I_filtered<-filter_low_var(t(df_correlation_net_stage_I), pct = 0.60, type = c("mean"))
df_stage_II_filtered<-filter_low_var(t(df_correlation_net_stage_II), pct = 0.60, type = c("mean"))
df_stage_III_filtered<-filter_low_var(t(df_correlation_net_stage_III), pct = 0.60, type = c("mean"))
