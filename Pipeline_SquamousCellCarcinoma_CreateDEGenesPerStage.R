...
for (stage_pair in rownames(df_stage_pairs))
{
	...
	selected_genes<-Normal_Tumor_sort_stages[Normal_Tumor_sort_stages[which(Normal_Tumor_sort_stages$Categories=="Up-regulated"),"log2FoldChange"]>1,]
