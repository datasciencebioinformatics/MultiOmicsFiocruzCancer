...
####################################################################################################################
list_stage_specific_genes<-list(sample_stage_I=c(),sample_stage_II=c(),sample_stage_III=c())
####################################################################################################################
...
{	
	...
	{
		# Concatenate genes
		list_stage_specific_genes[[Stage_i]]<-c(list_stage_specific_genes[[Stage_i]],selected_genes)	
	}
	####################################################################################################################		
