...
log2fc_expression_pos<-data.frame(Gene=rownames(log2fc_expression)[which(log2fc_expression>=1.58)],Expression=log2fc_expression[which(log2fc_expression>=1.58),])
