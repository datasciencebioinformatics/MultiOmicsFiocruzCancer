...
selected_genes_Stage_I_file       <-"/home/felipe/Documentos/LungPortal/output/DESeq2_uniq_selected_genes_Stage_pos_stage_I.tsv"             #
selected_genes_Stage_II_file      <-"/home/felipe/Documentos/LungPortal/output/DESeq2_uniq_selected_genes_Stage_pos_stage_II.tsv"            #
selected_genes_Stage_III_file     <-"/home/felipe/Documentos/LungPortal/output/DESeq2_uniq_selected_genes_Stage_pos_stage_III.tsv"           #
...
png(filename=paste(output_dir,"DESeq2_reducedTerms_stage_I.png",sep=""), width = 16, height = 14, res=600, units = "cm")
	treemapPlot(reducedTerms_stage_I)
dev.off()
# FindClusters_resolution
png(filename=paste(output_dir,"DESeq2_reducedTerms_stage_II.png",sep=""), width = 16, height = 14, res=600, units = "cm")
	treemapPlot(reducedTerms_stage_II)
dev.off()
# FindClusters_resolution
png(filename=paste(output_dir,"DESeq2_reducedTerms_stage_III.png",sep=""), width = 16, height = 14, res=600, units = "cm")
	treemapPlot(reducedTerms_stage_III)
dev.off()
#######################################################################################################################################
...
# plot: dot plot
# FindClusters_resolution
png(filename=paste(output_dir,"DESeq2_GOTerms_reducedTerms.png",sep=""), width = 20, height = 20, res=600, units = "cm")
