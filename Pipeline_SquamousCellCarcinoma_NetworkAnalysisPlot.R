...
###########################################################################################################################
# Relevel factor
Network_stages_value_file_data$Variable<-factor(Network_stages_value_file_data$Variable,levels=c("Number of nodes","Number of edges","Avg. number of neighbors","Network diameter","Network radius","Characteristic path length","Clustering coefficient","Network density","Network heterogeneity","Network centralization"))
